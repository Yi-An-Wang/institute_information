...
if EX==1
    % TWO or THREE ROBOTS
    dt=0.1; k_size=30;
    alpha1=1 ;  v_max=5; acc=10; vel_dif1=acc*dt; size1=10; 
    alpha2=0 ;  v_max2=5; acc=10; vel_dif2=acc*dt; size2=10; 
    robots = [ robots RobotClass([-80;0],[80;0],[0;0], 'red', alpha1, v_max,  vel_dif1, size1, 'circle')];
    robots = [ robots RobotClass([80;0],[-80;0],[0;0], 'green', alpha2, v_max2, vel_dif1, size2, 'circle')];
...
% extract velocity
        v1(:,N_steps)=robots(1).velocity;
        v2(:,N_steps)=robots(2).velocity;
...
fprintf('Number of steps %5d  #collisions %3d \n', N_steps, N_colisions); 
    ...
    % plot extracted velocity
    figure(2)
    t=0.05:0.05:N_steps*0.05;
    plot(t,v1(1,1:N_steps),t,v1(2,1:N_steps))
    legend('v_x','v_y')
end
