...
%% destination
% destination=[100; 900];
% destination=[900 -900 -900 900; 900 900 900 -900];
destination=2000*(rand(2,5)-rand(2,5));
% destination=[500+900*cos(pi/2:-pi/3:-pi/2); -500+900*sin(pi/2:-pi/3:-pi/2)];
goal_order=1;
...
%% senerial
robot1=rectangular_GBM([0; 0; 0],100,50,58,[0.15 0.7 0.3]);
